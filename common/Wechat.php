...
class Wechat extends Component
{
    ...
    protected function setCache($name, $value, $duration = null)
    {
        ...
        return Yii::$app->rdsRedis->setex($this->getCacheKey($name), $duration, json_encode($value));
    }
    ...
    {
        return json_decode(Yii::$app->rdsRedis->get($this->getCacheKey($name)), true);
    }
