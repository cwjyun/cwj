...
<head>
    ...
    <?= Html::cssFile('@web/assets/plugins/bootstrap/css/bootstrap.min.css')?>
   ...
   <?= Html::cssFile('@web/assets/plugins/parallax-slider/css/parallax-slider.css')?>
    <!-- CSS Theme -->
    <?= Html::cssFile('@web/assets/css/themes/default.css')?>
...
<div class="slider-inner">
    <div id="da-slider" class="da-slider">
        <div class="da-slide">
            ...
            <div class="da-img"><?= Html::img('@web/assets/plugins/parallax-slider/img/1.png')?></div>
        </div>
        <div class="da-slide">
        ...
        <div class="da-slide">
            ...
            <p><i>Lorem ipsum dolor amet</i> <br /> <i>tempor incididunt ut</i> <br /> <i>veniam omnis </i></p>
            <div class="da-img"><?= Html::img('@web/assets/plugins/parallax-slider/img/html5andcss3.png')?></div>
        </div>
        <nav class="da-arrows">
...
<div class="container">
    ...
    <ul class="thumbnails">
        <li class="span3">
            <div class="thumbnail-style thumbnail-kenburn">
                <div class="thumbnail-img">
                    <div class="overflow-hidden"><?= Html::img('@web/assets/img/carousel/2.jpg')?></div>
        ...
        <li class="span3">
            <div class="thumbnail-style thumbnail-kenburn">
                <div class="thumbnail-img">
                    <div class="overflow-hidden"><?= Html::img('@web/assets/img/carousel/3.jpg')?></div>
                    <a class="btn-more hover-effect" href="#">read more +</a>
                </div>
        ...
        <li class="span3">
            <div class="thumbnail-style thumbnail-kenburn">
                <div class="thumbnail-img">
                    <div class="overflow-hidden"><?= Html::img('@web/assets/img/carousel/9.jpg')?></div>
                    <a class="btn-more hover-effect" href="#">read more +</a>
                </div>
        ...
        <li class="span3">
            <div class="thumbnail-style thumbnail-kenburn">
                <div class="thumbnail-img">
                    <div class="overflow-hidden"><?= Html::img('@web/assets/img/carousel/10.jpg')?></div>
                    <a class="btn-more hover-effect" href="#">read more +</a>
                </div>
    ...
    <div class="row-fluid margin-bottom-20">
        ...
        <div class="span8">
            ...
            <p><?= Html::img('@web/assets/img/carousel/6.jpg',['class'=>'pull-left lft-img-margin img-width-200'])?>Unify is an incredibly beautiful responsive Bootstrap Template for corporate and creative professionals. It works on all major web browsers, tablets and phone.</p>
            <ul class="unstyled">
            ...
            <div id="myCarousel" class="carousel slide">
                <div class="carousel-inner">
                    <div class="item active">
                        <?= Html::img('@web/assets/img/carousel/5.jpg')?>
                        <div class="carousel-caption">
                            <p>Cras justo odio, dapibus ac facilisis in, egestas.</p>
                        </div>
                    </div>
                    <div class="item">
                        <?= Html::img('@web/assets/img/carousel/4.jpg')?>
                        <div class="carousel-caption">
                            <p>Cras justo odio, dapibus ac facilisis in, egestas.</p>
                        </div>
                    </div>
                    <div class="item">
                        <?= Html::img('@web/assets/img/carousel/3.jpg')?>
                        <div class="carousel-caption">
                            <p>Cras justo odio, dapibus ac facilisis in, egestas.</p>
                        </div>
                    </div>
    ...
    <div id="clients-flexslider" class="flexslider home clients">
        ...
        <ul class="slides">
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/hp_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/hp.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/igneus_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/igneus.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/vadafone_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/vadafone.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/walmart_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/walmart.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/shell_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/shell.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/natural_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/natural.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/aztec_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/aztec.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/gamescast_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/gamescast.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    "<?= Html::img('@web/assets/img/clients/cisco_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/cisco.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/everyday_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/everyday.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/cocacola_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/cocacola.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
                    <?= Html::img('@web/assets/img/clients/spinworkx_grey.png')?>
                    <?= Html::img('@web/assets/img/clients/spinworkx.png',['class'=>'color-img'])?>
                </a>
            </li>
            <li>
                <a href="#">
            ...
            <div class="span4">
                <div class="posts">
                    ...
                    <dl class="dl-horizontal">
                        <dt><a href="#"><?= Html::img('@web/assets/img/sliders/elastislide/6.jpg')?></a></dt>
                        <dd>
                            <p><a href="#">Anim moon officia Unify is an incredibly beautiful responsive Bootstrap Template</a></p>
                        </dd>
                    </dl>
                    <dl class="dl-horizontal">
                        <dt><a href="#"><?= Html::img('@web/assets/img/sliders/elastislide/10.jpg')?></a></dt>
                        <dd>
                            <p><a href="#">Anim moon officia Unify is an incredibly beautiful responsive Bootstrap Template</a></p>
                        </dd>
                    </dl>
                    <dl class="dl-horizontal">
                        <dt><a href="#"><?= Html::img('@web/assets/img/sliders/elastislide/11.jpg')?></a></dt>
                        <dd>
                            <p><a href="#">Anim moon officia Unify is an incredibly beautiful responsive Bootstrap Template</a></p>
                        </dd>
                    </dl>
...
<div class="copyright">
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="span4">
                <a href="index.html"><?= Html::img('@web/assets/img/logo2-default.png',['id'=>'logo-footer','class'=>'pull-right'])?></a>
            </div>
        </div><!--/row-fluid-->
    </div><!--/container-->
</div><!--/copyright-->
...
<?= Html::jsFile('@web/assets/js/jquery-1.8.2.min.js')?>
<?= Html::jsFile('@web/assets/js/modernizr.custom.js')?>
<?= Html::jsFile('@web/assets/plugins/bootstrap/js/bootstrap.min.js')?>
<!-- JS Implementing Plugins -->
<?= Html::jsFile('@web/assets/plugins/flexslider/jquery.flexslider-min.js')?>
<?= Html::jsFile('@web/assets/plugins/parallax-slider/js/modernizr.js')?>
<?= Html::jsFile('@web/assets/plugins/parallax-slider/js/jquery.cslider.js')?>
<?= Html::jsFile('@web/assets/plugins/back-to-top.js')?>
<!-- JS Page Level -->
<?= Html::jsFile('@web/assets/js/app.js')?>
<?= Html::jsFile('@web/assets/js/pages/index.js')?>
...
<!--[if lt IE 9]>
<script src="<?= Html::img('@web/assets/js/respond.js')?>"></script>
<![endif]-->
