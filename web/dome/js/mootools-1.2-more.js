...
},image:function(C,B){B=$merge({onload:$empty,onabort:$empty,onerror:$empty},B);var D=new Image();var A=$(D)||new Element("images");["load","abort","error"].each(function(E){var F="on"+E;
