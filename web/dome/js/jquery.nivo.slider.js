...
(function($) {
	...
	$.fn.nivoSlider = function(options) {
		...
		return this.each(function() {
			...
			//Get initial image
			if($(kids[vars.currentSlide]).is('images')){
			...
			if(settings.controlNav){
				...
				for(var i = 0; i < kids.length; i++){
					if(settings.controlNavThumbs){
						...
						nivoControl.append('<a class="nivo-control" rel="'+ i +'"><images src="'+ child.attr('src').replace(settings.controlNavThumbsSearch, settings.controlNavThumbsReplace) +'"></a>');
					} else {
